...
<div class="card green">
  ...
  <div class="general">
      ...
      <p>{{$usuario->email}}</p>
      <p>
      @if($usuario->rol == 1 ) Gerente @endif
      @if($usuario->rol == 2 ) empleado @endif
      @if($usuario->rol == 3 ) Cliente @endif
    </p>

    <p><a href="{{route('User.show', $usuario->id)}}" class="btn btn-info col-md-12">Editar</a></p>
